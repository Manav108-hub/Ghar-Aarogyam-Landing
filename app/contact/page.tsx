...
export default function Contact() {
  ...
  const handleWhatsApp = () => {
    const text = `Hi, I'm ${form.name || "a visitor"}.${form.phone ? ` Phone: ${form.phone}.` : ""} Message: ${form.message || "I'd like to enquire about Ghar Aarogyam."}`;
          ...
          <form onSubmit={handleSendEmail} className="space-y-4">
            ...
            <div className="flex items-center gap-4 pt-2">
              ...
              <button
                ...
                className="w-12 h-12 rounded-full flex items-center justify-center text-white shadow-md transition-all hover:opacity-90 disabled:opacity-50"
