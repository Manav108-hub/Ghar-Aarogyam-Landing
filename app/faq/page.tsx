    ...
    <main className="pt-[100px] min-h-screen bg-[#F0F9FF]">
      ...
      <section className="py-16 text-center text-white" style={{ background: 'linear-gradient(135deg, #7CC043 0%, #BAEAF7 100%)' }}>
        <div className="max-w-3xl mx-auto px-5">
          <h1 className="text-4xl md:text-5xl font-black mb-4">Everything you'd want to Know</h1>
      ...
      <section className="py-16">
        <div className="max-w-3xl mx-auto px-5">
          <div className="space-y-3">
            {faqs.map((faq, i) => (
              <details key={i} className="group bg-white border border-gray-200 rounded-2xl overflow-hidden cursor-pointer shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="px-6 pb-6 pt-3 text-gray-600 text-sm leading-relaxed border-t border-gray-100">
                  {faq.a}
                </div>
              </details>
            ))}
          ...
          <div className="mt-12 text-center bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
